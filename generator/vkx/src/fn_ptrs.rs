...
pub type vkAllocationFunction = unsafe extern "C" fn(*mut c_void, usize, usize, SystemAllocationScope) -> *mut c_void;
...
pub type vkInternalAllocationNotification = unsafe extern "C" fn(*mut c_void, usize, InternalAllocationType, SystemAllocationScope) ;
...
pub type vkInternalFreeNotification = unsafe extern "C" fn(*mut c_void, usize, InternalAllocationType, SystemAllocationScope) ;
...
pub type vkReallocationFunction = unsafe extern "C" fn(*mut c_void, *mut c_void, usize, usize, SystemAllocationScope) -> *mut c_void;
...
pub type vkDebugReportCallbackEXT = unsafe extern "C" fn(DebugReportFlagsEXT, DebugReportObjectTypeEXT, u64, usize, i32, *const c_char, *const c_char, *mut c_void) -> Bool32;
...
pub type vkDebugUtilsMessengerCallbackEXT = unsafe extern "C" fn(DebugUtilsMessageSeverityFlagsEXT, DebugUtilsMessageTypeFlagsEXT, *const DebugUtilsMessengerCallbackDataEXT, *mut c_void) -> Bool32;
...
pub type vkDeviceMemoryReportCallbackEXT = unsafe extern "C" fn(*const DeviceMemoryReportCallbackDataEXT, *mut c_void) ;
...
pub type vkGetInstanceProcAddrLUNARG = unsafe extern "C" fn(InstanceHandle, *const c_char) -> vkVoidFunction;
